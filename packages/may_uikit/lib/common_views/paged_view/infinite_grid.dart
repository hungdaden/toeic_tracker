...
import 'sliver_infinite_grid.dart';

/// {@template infinite_grid}
/// A widget that makes it easy to declaratively load and display paginated data
/// as a grid.
///
/// When the grid is scrolled to the end, the [onFetchData] callback will be
/// called.
///
...
///
/// See also:
/// - [SliverInfiniteGridV2]. The sliver version of this widget.
class InfiniteGridV2 extends StatelessWidget {
  /// {@macro infinite_grid}
  const InfiniteGridV2({
  ...
  /// {@template reverse}
  /// Indicates if the grid should be reversed.
  ///
  /// If set to `true`, the grid of items, [loadingBuilder] and [errorBuilder]
  ...
  /// The callback method that's called whenever the grid is scrolled to the end
  ...
  /// {@template padding}
  /// The optional amount of space by which to inset the grid of items.
  /// {@endtemplate}
  final EdgeInsets? padding;

  /// {@template empty_builder}
  /// An optional builder that's shown when the grid of items is empty.
  ///
  /// Defaults to [defaultInfiniteListEmptyBuilder].
  /// {@endtemplate}
  final WidgetBuilder? emptyBuilder;

  /// {@template loading_builder}
  /// An optional builder that's shown at the end of the grid when [isLoading]
  /// is `true`.
  ///
  ...
  /// An optional builder that's shown when [hasError] is true.
  /// Receives [BuildContext] and optional [Object] ([error]).
  ///
  /// Defaults to [defaultInfiniteListErrorBuilder].
  /// {@endtemplate}
  final InfiniteListErrorBuilder? errorBuilder;

  /// Optional [Object] passed to [errorBuilder] when [hasError] is true.
  final Object? error;
